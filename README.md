...
- [OOB Endpoints Table](#oob-endpoints-table): Mapping between OOB callbacks and vulnerabilities/techniques.
- [Polyglot Payloads OOB Endpoints Table](#polyglot-payloads-oob-endpoints-table): OOB endpoints specifically for polyglot payloads.
- [Polyglots Extended Payloads](#polyglots-extended-payloads): Advanced polyglot combinations across formats.
...
- [Detailed PDF Techniques](#detailed-pdf-techniques): In-depth list of PDF payloads by vulnerability type.
- [Detailed DOCX Techniques](#detailed-docx-techniques): DOCX-specific SSRF, XXE, LFI, and XSS techniques.
- [Detailed XLSX Techniques](#detailed-xlsx-techniques): XLSX SSRF, XXE, info leak, and XSS techniques.
- [Detailed SVG Techniques](#detailed-svg-techniques): SSRF, XXE, XSS, and LFI for SVG renderers.
- [Detailed Image Techniques](#detailed-image-techniques): PNG/JPEG/GIF techniques (XXE, SSRF, XSS, ImageTragick, etc.).
- [Detailed Archive Techniques](#detailed-archive-techniques): ZIP/JAR/EPUB XXE, path traversal, and RCE techniques.
- [Detailed Text File Techniques](#detailed-text-file-techniques): TXT/CSV/RTF XSS, SSRF, path traversal, and command injection.
- [Detailed OpenDocument Techniques](#detailed-opendocument-techniques): ODT/ODS/ODP XXE, XSS, and info leak.
- [Detailed XML Techniques](#detailed-xml-techniques): XML XXE, XSS, and path traversal.
- [Detailed HTML Techniques](#detailed-html-techniques): HTML XSS, SSRF, and RCE techniques.
- [Detailed PPTX Techniques](#detailed-pptx-techniques): PPTX SSRF, XXE, and XSS payloads.
- [Detailed WEBM Techniques](#detailed-webm-techniques): Binary parsing bugs (OOB, UAF, heap overflow, RCE, DoS, info leak).
