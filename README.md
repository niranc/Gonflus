...
For a structured overview of known rendering vulnerabilities, CVEs, PoCs, and the exact payloads generated by this tool for each supported format, see `cve_known_rendering.md` at the root of the repository.
